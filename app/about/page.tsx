      ...
      <div className="space-y-10 max-w-3xl">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            SkillPerks helps developers and tech professionals choose learning platforms with confidence—by combining verified deals,
            honest reviews, and practical comparisons.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>
              We focus on the job-to-be-done: picking the right course for a specific outcome (e.g., “pass system design interviews”,
              “learn SQL for analytics”, “build production React apps”).
            </p>
            <p>
